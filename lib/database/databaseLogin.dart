...
// 登陆时模拟表
class DataBaseSigninProvider {
  DataBaseSigninProvider._();
  static final table = 'SigninClient';
  static final DataBaseSigninProvider db = DataBaseSigninProvider._();
  Database _database;
  ...
  initDB() async {
    ...
    String path = join(documentsDirectory.path, "SignDB.db");
